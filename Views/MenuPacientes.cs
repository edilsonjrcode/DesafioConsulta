    ...
    public class MenuPacientes(PacienteController pacienteController, ConsultaController consultaController)
    {
        ...
        public void VDeletarPaciente()
        {
            ...
            try
            {
                ...
                consultaController.DeleteAgendamentosAntigos(cpf);
        ...
        public void VListarPacientePorCpf()
        {
            ...
            foreach (PacienteDto paciente in pacientes)
            {
                ...
                {
                    Console.WriteLine("             Agendado para: {0}", consultas[0].DataConsulta.ConverteData().ToString("dd/MM/yyyy"));
                    Console.WriteLine("             {0} às {1}", consultas[0].HoraInicial.ConverteHora(), consultas[0].HoraFinal.ConverteHora());
                }
            }
            Console.WriteLine("------------------------------------------------------------");
        }
